...
alias mm.check="ruff . --fix && mypy --strict-optional --check-untyped-defs --disallow-incomplete-defs --warn-unused-configs --follow-imports=normal api/ && yarn eslint ./frontend/**/*.ts && ag jbootz"
alias mm.c="mm.check"
